...
import '../Styles/carrusel_info.css'; // Importa tu archivo CSS personalizado
            ...
            <div id="miCarrusel" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner carousel-container">
                    ...
                    <div className="carousel-item active">
                        <img src={Imagen1} className="carousel-main-image" alt="Imagen Principal" />
                    </div>
                        ...
                        <div className="carousel-card-container">
                            <div className="custom-card">
                                <div className="card-image-section">
                                    <img src={Rafael} className="card-image" alt="Rafael" />
                                </div>
                    ...
                    <div className="carousel-item">
                        <div className="carousel-card-container">
                            <div className="custom-card">
                                <div className="card-image-section">
                                    <img src={Esau} className="card-image" alt="Esau" />
                                </div>
                                <div className="card-content-section">
